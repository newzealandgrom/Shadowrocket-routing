/*
 * Проверка сервисов для Shadowrocket: страница https://sr.test/ из модуля modules/Service-Check-RU.module.
 *
 *   https://sr.test/        — страница с кнопками проверок;
 *   https://sr.test/route   — IP напрямую (Яндекс) и через прокси (ipinfo.io): работает ли разделение трафика;
 *   https://sr.test/sites   — отвечают ли ключевые сайты: российские напрямую, зарубежные через прокси.
 *
