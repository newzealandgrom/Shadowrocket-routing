...
Проверки сервисов выполняют скрипты [huskydsb/Shadowrocket](https://github.com/huskydsb/Shadowrocket). Они отвечают на китайском и английском, страница переводит ответы на русский. Утечку DNS проверяет скрипт этого репозитория через сервис surfsharkdns.com. Все запросы идут по правилам вашего конфига. Если страница не открывается:
